...
async def get_merit_demerit(
    ...
    m.SCHOOL_REQUESTS_TOTAL.labels(school_name=school_name, api_version="v5", data_type="merit_demerit").inc()
...
async def get_attendance(
    ...
    m.SCHOOL_REQUESTS_TOTAL.labels(school_name=school_name, api_version="v5", data_type="attendance").inc()
...
async def get_exam_menu(
    ...
    m.SCHOOL_REQUESTS_TOTAL.labels(school_name=school_name, api_version="v5", data_type="exam_menu").inc()
...
async def get_semester_scores(
    ...
    m.SCHOOL_REQUESTS_TOTAL.labels(school_name=school_name, api_version="v5", data_type="semester_scores").inc()
